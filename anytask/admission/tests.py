...
class ViewsTest(TestCase):
    ...
    def test_register_activate(self, mock_contest_register):
        ...
        post_data = {
            ...
            u'field_2': [u'{"question": {"id": 2, "label": {"ru": "q2"}}, "value": "'+ test_data['first_name'] + u'"}'],
            u'field_3': [u'{"question": {"id": 3, "label": {"ru": "q3"}}, "value": "'+ test_data['middle_name'] + u'"}'],
            ...
            u'field_6': [u'{"question": {"id": 6, "label": {"ru": "q6"}}, "value": "'+ test_data['birth_date'] + u'"}'],
            u'field_7': [u'{"question": {"id": 7, "label": {"ru": "q7"}}, "value": "'+ test_data['city_of_residence'] + u'"}'],
            u'field_8': [u'{"question": {"id": 8, "label": {"ru": "q8"}}, "value": "'+ test_data['filial'] + u'"}'],
            u'field_9': [u'{"question": {"id": 9, "label": {"ru": "q9"}}, "value": "'+ test_data['university'] + u'"}'],
            u'field_10': [u'{"question": {"id": 10, "label": {"ru": "q10"}}, "value": "'+ test_data['university_text'] + u'"}'],
            u'field_11': [u'{"question": {"id": 11, "label": {"ru": "q11"}}, "value": "'+ test_data['university_in_process'] + u'"}'],
            u'field_12': [u'{"question": {"id": 12, "label": {"ru": "q12"}}, "value": "'+ test_data['university_class'] + u'"}'],
            u'field_13': [u'{"question": {"id": 13, "label": {"ru": "q13"}}, "value": "'+ test_data['university_class_text'] + u'"}'],
            u'field_14': [u'{"question": {"id": 14, "label": {"ru": "q14"}}, "value": "'+ test_data['university_department'] + u'"}'],
            u'field_15': [u'{"question": {"id": 15, "label": {"ru": "q15"}}, "value": "'+ test_data['university_year_end'] + u'"}'],
            u'field_16': [u'{"question": {"id": 16, "label": {"ru": "q16"}}, "value": "'+ test_data_additional['field_16'] + u'"}'],
            u'field_17': [u'{"question": {"id": 17, "label": {"ru": "q17"}}, "value": "'+ test_data_additional['field_17'] + u'"}'],
            u'field_18': [u'{"question": {"id": 18, "label": {"ru": "q18"}}, "value": "'+ test_data_additional['field_18'] + u'"}'],
            u'field_19': [u'{"question": {"id": 19, "label": {"ru": "q19"}}, "value": "'+ test_data_additional['field_19'] + u'"}'],
        }

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ContestSubmission'
        db.create_table('anycontest_contestsubmission', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('issue', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['issues.Issue'])),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('file', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['issues.File'])),
            ('run_id', self.gf('django.db.models.fields.CharField')(max_length=191, blank=True)),
            ('compiler_id', self.gf('django.db.models.fields.CharField')(max_length=191, blank=True)),
            ('send_error', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('got_verdict', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('full_response', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('verdict', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('precompile_checks', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('compile_log', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('used_time', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('used_memory', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('error', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('message', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('test_number', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('create_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('update_time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('anycontest', ['ContestSubmission'])


    def backwards(self, orm):
        # Deleting model 'ContestSubmission'
        db.delete_table('anycontest_contestsubmission')

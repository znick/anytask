...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContestSubmission.sended_notify'
        db.add_column('anycontest_contestsubmission', 'sended_notify',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ContestSubmission.sended_notify'
        db.delete_column('anycontest_contestsubmission', 'sended_notify')
    ...
    models = {
        ...
        'courses.course': {
            ...
            'use_task_tags': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'tasks.task': {
            ...
            'hidden_in_groups': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'hidden_tasks'", 'to': "orm['groups.Group']", 'blank': 'True', 'symmetrical': 'False', 'null': 'True', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'tag': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['tasks.TaskTag']", 'null': 'True', 'blank': 'True'}),
            ...
            'url': ('django.db.models.fields.CharField', [], {'max_length': '191', 'null': 'True', 'blank': 'True'}),
            'weight': ('django.db.models.fields.IntegerField', [], {'default': '0', 'db_index': 'True'})
        },
        'tasks.tasktag': {
            'Meta': {'object_name': 'TaskTag'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '191', 'db_index': 'True'})
        },
        'years.year': {

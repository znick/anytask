        ...
        i.prototype = {
            ...
            buildDropdownOptions: function () {
                this.$select.children().each(t.proxy(function (e, i) {
                    ...
                    t("li:not(.multiselect-group) input", this.$ul).on("change", t.proxy(function (e) {
                        var i = t(e.target)
                            , s = i.prop("checked") || !1
                        ...
                        return l ? s ? this.selectAll(this.options.selectAllJustVisible, !0) : this.deselectAll(this.options.selectAllJustVisible, !0) : (s ? (n.prop("selected", !0),
                ...
                this.options.enableClickableOptGroups && this.options.multiple && t("li.multiselect-group input", this.$ul).on("change", t.proxy(function (e) {
                    ...
                    var i = t(e.target)
                        ...
                        , n = o.find("input")
                        , a = [];
                    this.options.selectedClass && (s ? l.addClass(this.options.selectedClass) : l.removeClass(this.options.selectedClass)),
                        t.each(n, t.proxy(function (e, i) {
                            ...
                            s ? (t(i).prop("checked", !0),
                                ...
                                o.prop("selected", !0)) : (t(i).prop("checked", !1),
                                t(i).closest("li").removeClass(this.options.selectedClass),
                                o.prop("selected", !1)),
                                a.push(this.getOptionByValue(l))
                        }, this)),
                        this.options.onChange(a, s),
                        this.updateButtonText(),
                        this.updateSelectAll()
                }, this)),
                                        ...
                                        if (this.query !== e.target.value) {
                                            ...
                                            t.each(t("li", this.$ul), t.proxy(function (e, l) {
                                                ...
                                                if ("text" === this.options.filterBehavior ? a = n : "value" === this.options.filterBehavior ? a = o : "both" === this.options.filterBehavior && (a = n + "\n" + o),
                                                    ...
                                                    t(l).toggle(p).toggleClass("multiselect-filter-hidden", !p),
            ...
            updateOptGroups: function () {
                if (!this.options.manualUpdateOptGroups) {

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Cource'
        db.create_table('cources_cource', (
        ...
        db.send_create_signal('cources', ['Cource'])

        # Adding M2M table for field students on 'Cource'
        db.create_table('cources_cource_students', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('cource', models.ForeignKey(orm['cources.cource'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('cources_cource_students', ['cource_id', 'user_id'])

        # Adding M2M table for field groups on 'Cource'
        db.create_table('cources_cource_groups', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('cource', models.ForeignKey(orm['cources.cource'], null=False)),
            ('group', models.ForeignKey(orm['groups.group'], null=False))
        ))
        db.create_unique('cources_cource_groups', ['cource_id', 'group_id'])


    def backwards(self, orm):
        
        # Deleting model 'Cource'
        db.delete_table('cources_cource')

        # Removing M2M table for field students on 'Cource'
        db.delete_table('cources_cource_students')

        # Removing M2M table for field groups on 'Cource'
        db.delete_table('cources_cource_groups')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Cource.year'
        db.add_column('cources_cource', 'year', self.gf('django.db.models.fields.related.ForeignKey')(default=2012, to=orm['years.Year'], blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Cource.year'
        db.delete_column('cources_cource', 'year_id')

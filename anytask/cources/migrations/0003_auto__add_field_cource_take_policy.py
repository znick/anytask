...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Cource.take_policy'
        db.add_column('cources_cource', 'take_policy', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=1, null=True, db_index=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Cource.take_policy'
        db.delete_column('cources_cource', 'take_policy')

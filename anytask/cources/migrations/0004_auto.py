...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field teachers on 'Cource'
        db.create_table('cources_cource_teachers', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('cource', models.ForeignKey(orm['cources.cource'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('cources_cource_teachers', ['cource_id', 'user_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field teachers on 'Cource'
        db.delete_table('cources_cource_teachers')

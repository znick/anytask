...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Cource.max_users_per_task'
        db.add_column('cources_cource', 'max_users_per_task', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Cource.max_users_per_task'
        db.delete_column('cources_cource', 'max_users_per_task')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 3, 20, 13, 44, 738906)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 3, 20, 13, 44, 738770)'}),

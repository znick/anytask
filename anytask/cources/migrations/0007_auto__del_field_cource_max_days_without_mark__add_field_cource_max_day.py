...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Cource.max_days_without_score'
        db.add_column('cources_cource', 'max_days_without_score', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Cource.max_days_without_score'
        db.delete_column('cources_cource', 'max_days_without_score')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 3, 22, 44, 37, 306920)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 3, 22, 44, 37, 306739)'}),

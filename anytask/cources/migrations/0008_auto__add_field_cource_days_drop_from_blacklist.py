...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Cource.days_drop_from_blacklist'
        db.add_column('cources_cource', 'days_drop_from_blacklist', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Cource.days_drop_from_blacklist'
        db.delete_column('cources_cource', 'days_drop_from_blacklist')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 3, 23, 1, 30, 335145)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 3, 23, 1, 30, 334962)'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Cource.max_tasks_withoout_score_per_student'
        db.delete_column('cources_cource', 'max_tasks_withoout_score_per_student')

        # Adding field 'Cource.max_tasks_without_score_per_student'
        db.add_column('cources_cource', 'max_tasks_without_score_per_student', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Cource.max_tasks_withoout_score_per_student'
        db.add_column('cources_cource', 'max_tasks_withoout_score_per_student', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True), keep_default=False)

        # Deleting field 'Cource.max_tasks_without_score_per_student'
        db.delete_column('cources_cource', 'max_tasks_without_score_per_student')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 15, 19, 11, 35, 490851)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 15, 19, 11, 35, 490716)'}),

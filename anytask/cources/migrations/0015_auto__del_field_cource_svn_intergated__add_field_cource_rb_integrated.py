...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Cource.svn_intergated'
        db.delete_column('cources_cource', 'svn_intergated')

        # Adding field 'Cource.rb_integrated'
        db.add_column('cources_cource', 'rb_integrated',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Cource.svn_intergated'
        db.add_column('cources_cource', 'svn_intergated',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Cource.rb_integrated'
        db.delete_column('cources_cource', 'rb_integrated')

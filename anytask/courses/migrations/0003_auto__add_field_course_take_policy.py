...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('courses_course', 'take_policy', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=1, null=True, db_index=True, blank=True), keep_default=False)

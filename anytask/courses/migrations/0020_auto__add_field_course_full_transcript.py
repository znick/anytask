...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.full_transcript'
        db.add_column('courses_course', 'full_transcript',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Removing M2M table for field curators on 'Course'
        db.delete_table('courses_course_curators')


    def backwards(self, orm):
        # Deleting field 'Course.full_transcript'
        db.delete_column('courses_course', 'full_transcript')

        # Adding M2M table for field curators on 'Course'
        db.create_table('courses_course_curators', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('course', models.ForeignKey(orm['courses.course'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('courses_course_curators', ['course_id', 'user_id'])

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field filename_extensions on 'Course'
        db.create_table('courses_course_filename_extensions', (
        ...
        db.create_unique('courses_course_filename_extensions', ['course_id', 'filenameextension_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field filename_extensions on 'Course'
        db.delete_table('courses_course_filename_extensions')

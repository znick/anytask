...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('courses_defaultteacher', (
            ...
            ('teacher', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], db_index=False)),
        ...
        # Adding unique constraint on 'DefaultTeacher', fields ['course', 'group']
        db.create_unique('courses_defaultteacher', ['course_id', 'group_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'DefaultTeacher', fields ['course', 'group']
        db.delete_unique('courses_defaultteacher', ['course_id', 'group_id'])
    ...
    models = {
        ...
        'courses.defaultteacher': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'teacher': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'db_index': 'False'})
        },

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'StudentCourseMark.teacher'
        db.add_column('courses_studentcoursemark', 'teacher',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='teacher_change_mark', null=True, db_index=False, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'StudentCourseMark.update_time'
        db.add_column('courses_studentcoursemark', 'update_time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now=True, blank=True),
                      keep_default=False)

        # Removing index on 'StudentCourseMark', fields ['course']
        db.delete_index('courses_studentcoursemark', ['course_id'])

        # Removing index on 'StudentCourseMark', fields ['group']
        db.delete_index('courses_studentcoursemark', ['group_id'])

        # Adding index on 'StudentCourseMark', fields ['student']
        db.create_index('courses_studentcoursemark', ['student_id'])


        # Renaming column for 'StudentCourseMark.mark' to match new field type.
        db.rename_column('courses_studentcoursemark', 'mark', 'mark_id')
        # Changing field 'StudentCourseMark.mark'
        db.alter_column('courses_studentcoursemark', 'mark_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['courses.MarkField'], null=True))
        # Removing index on 'StudentCourseMark', fields ['mark']
        db.delete_index('courses_studentcoursemark', ['mark'])


    def backwards(self, orm):
        # Adding index on 'StudentCourseMark', fields ['mark']
        db.create_index('courses_studentcoursemark', ['mark'])

        # Removing index on 'StudentCourseMark', fields ['student']
        db.delete_index('courses_studentcoursemark', ['student_id'])

        # Adding index on 'StudentCourseMark', fields ['group']
        db.create_index('courses_studentcoursemark', ['group_id'])

        # Adding index on 'StudentCourseMark', fields ['course']
        db.create_index('courses_studentcoursemark', ['course_id'])
        ...
        # Deleting field 'StudentCourseMark.teacher'
        db.delete_column('courses_studentcoursemark', 'teacher_id')

        # Deleting field 'StudentCourseMark.update_time'
        db.delete_column('courses_studentcoursemark', 'update_time')


        # Renaming column for 'StudentCourseMark.mark' to match new field type.
        db.rename_column('courses_studentcoursemark', 'mark_id', 'mark')
        # Changing field 'StudentCourseMark.mark'
        db.alter_column('courses_studentcoursemark', 'mark', self.gf('django.db.models.fields.IntegerField')())

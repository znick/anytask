...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.send_to_contest_from_users'
        db.add_column('courses_course', 'send_to_contest_from_users',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.send_to_contest_from_users'
        db.delete_column('courses_course', 'send_to_contest_from_users')

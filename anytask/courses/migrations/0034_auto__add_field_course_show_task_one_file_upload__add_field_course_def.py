...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.show_task_one_file_upload'
        db.add_column('courses_course', 'show_task_one_file_upload',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Course.default_task_one_file_upload'
        db.add_column('courses_course', 'default_task_one_file_upload',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.show_task_one_file_upload'
        db.delete_column('courses_course', 'show_task_one_file_upload')

        # Deleting field 'Course.default_task_one_file_upload'
        db.delete_column('courses_course', 'default_task_one_file_upload')

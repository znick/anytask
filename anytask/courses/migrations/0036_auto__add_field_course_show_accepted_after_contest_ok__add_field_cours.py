...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.show_accepted_after_contest_ok'
        db.add_column('courses_course', 'show_accepted_after_contest_ok',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Course.default_accepted_after_contest_ok'
        db.add_column('courses_course', 'default_accepted_after_contest_ok',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.show_accepted_after_contest_ok'
        db.delete_column('courses_course', 'show_accepted_after_contest_ok')

        # Deleting field 'Course.default_accepted_after_contest_ok'
        db.delete_column('courses_course', 'default_accepted_after_contest_ok')

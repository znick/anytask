...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'StudentCourseMark.group'
        db.delete_column('courses_studentcoursemark', 'group_id')

        # Adding unique constraint on 'StudentCourseMark', fields ['student', 'course']
        db.create_unique('courses_studentcoursemark', ['student_id', 'course_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'StudentCourseMark', fields ['student', 'course']
        db.delete_unique('courses_studentcoursemark', ['student_id', 'course_id'])

        # Adding field 'StudentCourseMark.group'
        db.add_column('courses_studentcoursemark', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['groups.Group'], null=True, db_index=False),
                      keep_default=False)

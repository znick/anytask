...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.is_python_task'
        db.add_column('courses_course', 'is_python_task',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.is_python_task'
        db.delete_column('courses_course', 'is_python_task')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CourseGroupObjectPermission'
        db.create_table('courses_coursegroupobjectpermission', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('permission', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.Permission'])),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.Group'])),
            ('content_object', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['courses.Course'])),
        ))
        db.send_create_signal('courses', ['CourseGroupObjectPermission'])

        # Adding unique constraint on 'CourseGroupObjectPermission', fields ['group', 'permission', 'content_object']
        db.create_unique('courses_coursegroupobjectpermission', ['group_id', 'permission_id', 'content_object_id'])

        # Adding model 'CourseUserObjectPermission'
        db.create_table('courses_courseuserobjectpermission', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('courses', ['CourseUserObjectPermission'])

        # Adding unique constraint on 'CourseUserObjectPermission', fields ['user', 'permission', 'content_object']
        db.create_unique('courses_courseuserobjectpermission', ['user_id', 'permission_id', 'content_object_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'CourseUserObjectPermission', fields ['user', 'permission', 'content_object']
        db.delete_unique('courses_courseuserobjectpermission', ['user_id', 'permission_id', 'content_object_id'])

        # Removing unique constraint on 'CourseGroupObjectPermission', fields ['group', 'permission', 'content_object']
        db.delete_unique('courses_coursegroupobjectpermission', ['group_id', 'permission_id', 'content_object_id'])

        # Deleting model 'CourseGroupObjectPermission'
        db.delete_table('courses_coursegroupobjectpermission')

        # Deleting model 'CourseUserObjectPermission'
        db.delete_table('courses_courseuserobjectpermission')
    ...
    models = {
        ...
        'courses.coursegroupobjectpermission': {
            'Meta': {'unique_together': "([u'group', u'permission', u'content_object'],)", 'object_name': 'CourseGroupObjectPermission'},
            'content_object': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['courses.Course']"}),
        ...
        'courses.courseuserobjectpermission': {
            'Meta': {'unique_together': "([u'user', u'permission', u'content_object'],)", 'object_name': 'CourseUserObjectPermission'},
            'content_object': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['courses.Course']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'permission': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.Permission']"}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.take_mark_from_contest'
        db.add_column('courses_course', 'take_mark_from_contest',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.take_mark_from_contest'
        db.delete_column('courses_course', 'take_mark_from_contest')
    ...
    models = {
        ...
        'courses.course': {
            ...
            'year': ('django.db.models.fields.related.ForeignKey', [], {'default': '2018', 'to': "orm['years.Year']"})
        },

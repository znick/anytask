...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('courses_course', 'year', self.gf('django.db.models.fields.related.ForeignKey')(default=2012, to=orm['years.Year'], blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Course.year'
        db.delete_column('courses_course', 'year_id')

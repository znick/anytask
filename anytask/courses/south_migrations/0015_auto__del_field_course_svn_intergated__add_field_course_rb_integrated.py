...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Course.svn_intergated'
        db.delete_column('courses_course', 'svn_intergated')

        # Adding field 'Course.rb_integrated'
        db.add_column('courses_course', 'rb_integrated',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Course.svn_intergated'
        db.add_column('courses_course', 'svn_intergated',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Course.rb_integrated'
        db.delete_column('courses_course', 'rb_integrated')

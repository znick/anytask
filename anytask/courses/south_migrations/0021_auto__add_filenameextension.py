...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FilenameExtension'
        db.create_table('courses_filenameextension', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=10)),
        ))
        db.send_create_signal('courses', ['FilenameExtension'])

        # Adding M2M table for field file_extensions on 'Course'
        db.create_table('courses_course_file_extensions', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('course', models.ForeignKey(orm['courses.course'], null=False)),
            ('filenameextension', models.ForeignKey(orm['courses.filenameextension'], null=False))
        ))
        db.create_unique('courses_course_file_extensions', ['course_id', 'filenameextension_id'])


    def backwards(self, orm):
        # Deleting model 'FilenameExtension'
        db.delete_table('courses_filenameextension')

        # Removing M2M table for field file_extensions on 'Course'
        db.delete_table('courses_course_file_extensions')
    ...
    models = {
        ...
        'courses.course': {
            ...
            'file_extensions': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'filename_extensions_set'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['courses.FilenameExtension']"}),

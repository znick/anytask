...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing M2M table for field fields on 'Course'
        db.delete_table(db.shorten_name('courses_course_fields'))

        # Adding M2M table for field issue_fields on 'Course'
        m2m_table_name = db.shorten_name('courses_course_issue_fields')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('course', models.ForeignKey(orm['courses.course'], null=False)),
            ('issuefield', models.ForeignKey(orm['issues.issuefield'], null=False))
        ))
        db.create_unique(m2m_table_name, ['course_id', 'issuefield_id'])


    def backwards(self, orm):
        # Adding M2M table for field fields on 'Course'
        m2m_table_name = db.shorten_name('courses_course_fields')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('course', models.ForeignKey(orm['courses.course'], null=False)),
            ('issuefield', models.ForeignKey(orm['issues.issuefield'], null=False))
        ...
        # Removing M2M table for field issue_fields on 'Course'
        db.delete_table(db.shorten_name('courses_course_issue_fields'))

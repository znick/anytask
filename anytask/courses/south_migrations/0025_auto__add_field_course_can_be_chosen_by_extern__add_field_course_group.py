...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.can_be_chosen_by_extern'
        db.add_column('courses_course', 'can_be_chosen_by_extern',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Course.group_with_extern'
        db.add_column('courses_course', 'group_with_extern',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='course_with_extern', null=True, db_index=False, to=orm['groups.Group']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.can_be_chosen_by_extern'
        db.delete_column('courses_course', 'can_be_chosen_by_extern')

        # Deleting field 'Course.group_with_extern'
        db.delete_column('courses_course', 'group_with_extern_id')

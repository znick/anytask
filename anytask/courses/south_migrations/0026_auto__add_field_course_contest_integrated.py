...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.contest_integrated'
        db.add_column('courses_course', 'contest_integrated',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.contest_integrated'
        db.delete_column('courses_course', 'contest_integrated')

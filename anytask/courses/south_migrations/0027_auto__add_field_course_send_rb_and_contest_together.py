...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.send_rb_and_contest_together'
        db.add_column('courses_course', 'send_rb_and_contest_together',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.send_rb_and_contest_together'
        db.delete_column('courses_course', 'send_rb_and_contest_together')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DefaultTeacher.teacher'
        db.alter_column('courses_defaultteacher', 'teacher_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

    def backwards(self, orm):

        # Changing field 'DefaultTeacher.teacher'
        db.alter_column('courses_defaultteacher', 'teacher_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']))

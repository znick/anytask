...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MarkField.name'
        db.alter_column('courses_markfield', 'name', self.gf('django.db.models.fields.CharField')(max_length=191))

        # Changing field 'CourseMarkSystem.name'
        db.alter_column('courses_coursemarksystem', 'name', self.gf('django.db.models.fields.CharField')(max_length=191))

        # Changing field 'Course.name_id'
        db.alter_column('courses_course', 'name_id', self.gf('django.db.models.fields.CharField')(max_length=191, null=True))

        # Changing field 'Course.name'
        db.alter_column('courses_course', 'name', self.gf('django.db.models.fields.CharField')(max_length=191))

    def backwards(self, orm):

        # Changing field 'MarkField.name'
        db.alter_column('courses_markfield', 'name', self.gf('django.db.models.fields.CharField')(max_length=254))

        # Changing field 'CourseMarkSystem.name'
        db.alter_column('courses_coursemarksystem', 'name', self.gf('django.db.models.fields.CharField')(max_length=254))

        # Changing field 'Course.name_id'
        db.alter_column('courses_course', 'name_id', self.gf('django.db.models.fields.CharField')(max_length=254, null=True))

        # Changing field 'Course.name'
        db.alter_column('courses_course', 'name', self.gf('django.db.models.fields.CharField')(max_length=254))

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.show_contest_run_id'
        db.add_column('courses_course', 'show_contest_run_id',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.show_contest_run_id'
        db.delete_column('courses_course', 'show_contest_run_id')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EasyCiRun'
        db.create_table('easy_ci_easycirun', (
        ...
        db.send_create_signal('easy_ci', ['EasyCiRun'])


    def backwards(self, orm):
        # Deleting model 'EasyCiRun'
        db.delete_table('easy_ci_easycirun')

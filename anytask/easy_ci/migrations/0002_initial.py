...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EasyCiTask'
        db.create_table('easy_ci_easycitask', (
        ...
        db.send_create_signal('easy_ci', ['EasyCiTask'])

        # Adding model 'EasyCiCheck'
        db.create_table('easy_ci_easycicheck', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('easy_ci_task', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['easy_ci.EasyCiTask'])),
            ('success', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('output', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('easy_ci', ['EasyCiCheck'])


    def backwards(self, orm):
        # Deleting model 'EasyCiTask'
        db.delete_table('easy_ci_easycitask')

        # Deleting model 'EasyCiCheck'
        db.delete_table('easy_ci_easycicheck')

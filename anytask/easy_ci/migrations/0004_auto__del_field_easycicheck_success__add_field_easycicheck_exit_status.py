...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'EasyCiCheck.success'
        db.delete_column('easy_ci_easycicheck', 'success')

        # Adding field 'EasyCiCheck.exit_status'
        db.add_column('easy_ci_easycicheck', 'exit_status',
                      self.gf('django.db.models.fields.IntegerField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'EasyCiCheck.success'
        db.add_column('easy_ci_easycicheck', 'success',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'EasyCiCheck.exit_status'
        db.delete_column('easy_ci_easycicheck', 'exit_status')
    ...
    models = {
        ...
        'easy_ci.easycicheck': {
            ...
            'exit_status': ('django.db.models.fields.IntegerField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

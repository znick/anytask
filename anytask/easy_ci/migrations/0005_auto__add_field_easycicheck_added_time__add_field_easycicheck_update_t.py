...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EasyCiCheck.added_time'
        db.add_column('easy_ci_easycicheck', 'added_time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, blank=True),
                      keep_default=False)

        # Adding field 'EasyCiCheck.update_time'
        db.add_column('easy_ci_easycicheck', 'update_time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now=True, blank=True),
                      keep_default=False)


        # Changing field 'EasyCiCheck.exit_status'
        db.alter_column('easy_ci_easycicheck', 'exit_status', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):
        # Deleting field 'EasyCiCheck.added_time'
        db.delete_column('easy_ci_easycicheck', 'added_time')

        # Deleting field 'EasyCiCheck.update_time'
        db.delete_column('easy_ci_easycicheck', 'update_time')


        # Changing field 'EasyCiCheck.exit_status'
        db.alter_column('easy_ci_easycicheck', 'exit_status', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        'cources.cource': {
            ...
            'easy_ci': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'easy_ci.easycicheck': {
            'Meta': {'object_name': 'EasyCiCheck'},
            'added_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'easy_ci_task': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['easy_ci.EasyCiTask']"}),

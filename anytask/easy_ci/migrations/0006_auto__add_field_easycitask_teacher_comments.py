...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EasyCiTask.teacher_comments'
        db.add_column('easy_ci_easycitask', 'teacher_comments',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EasyCiTask.teacher_comments'
        db.delete_column('easy_ci_easycitask', 'teacher_comments')

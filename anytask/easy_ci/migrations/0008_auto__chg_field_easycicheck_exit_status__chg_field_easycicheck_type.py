...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EasyCiCheck.type'
        db.alter_column('easy_ci_easycicheck', 'type', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))

    def backwards(self, orm):

        # Changing field 'EasyCiCheck.exit_status'
        db.alter_column('easy_ci_easycicheck', 'exit_status', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))

        # Changing field 'EasyCiCheck.type'
        db.alter_column('easy_ci_easycicheck', 'type', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    models = {
        ...
        'easy_ci.easycitask': {
            ...
            'teacher_comments': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'update_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'})
        },
        'groups.group': {

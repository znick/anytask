...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('groups_group', 'name', self.gf('django.db.models.fields.CharField')(max_length=254))


    def backwards(self, orm):
        
        # Changing field 'Group.name'
        db.alter_column('groups_group', 'name', self.gf('django.db.models.fields.CharField')(max_length=256))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 15, 21, 9, 38, 613601)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 15, 21, 9, 38, 613419)'}),

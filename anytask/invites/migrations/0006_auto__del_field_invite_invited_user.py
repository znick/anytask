...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Invite.invited_user'
        db.delete_column('invites_invite', 'invited_user_id')


    def backwards(self, orm):
        # Adding field 'Invite.invited_user'
        db.add_column('invites_invite', 'invited_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(db_index=False, related_name='initve_invited', null=True, to=orm['auth.User'], blank=True),
                      keep_default=False)

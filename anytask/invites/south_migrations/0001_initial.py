...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('invites_invite', (
            ...
            ('generated_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='invite_generated_by', db_index=False, to=orm['auth.User'])),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(db_index=False, to=orm['groups.Group'], null=True, blank=True)),
            ('invited_user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='initve_invited', db_index=False, to=orm['auth.User'])),
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 17, 16, 28, 31, 591903)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 17, 16, 28, 31, 591720)'}),
        ...
        'invites.invite': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invited_user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'initve_invited'", 'db_index': 'False', 'to': "orm['auth.User']"}),

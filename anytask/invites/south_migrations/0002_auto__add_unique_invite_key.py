...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Invite', fields ['key']
        db.create_unique('invites_invite', ['key'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Invite', fields ['key']
        db.delete_unique('invites_invite', ['key'])
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 18, 2, 2, 44, 492761)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 18, 2, 2, 44, 492582)'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Invite.invited_user'
        db.alter_column('invites_invite', 'invited_user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))


    def backwards(self, orm):
        
        # Changing field 'Invite.invited_user'
        db.alter_column('invites_invite', 'invited_user_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['auth.User']))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 18, 2, 11, 56, 118162)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 18, 2, 11, 56, 117903)'}),
        ...
        'invites.invite': {
            ...
            'added_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'generated_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'invite_generated_by'", 'db_index': 'False', 'to': "orm['auth.User']"}),
            'group': ('django.db.models.fields.related.ForeignKey', [], {'db_index': 'False', 'to': "orm['groups.Group']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invited_user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'initve_invited'", 'null': 'True', 'db_index': 'False', 'to': "orm['auth.User']"}),

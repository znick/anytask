...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field invited_users on 'Invite'
        m2m_table_name = db.shorten_name('invites_invite_invited_users')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('invite', models.ForeignKey(orm['invites.invite'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique(m2m_table_name, ['invite_id', 'user_id'])


    def backwards(self, orm):
        # Removing M2M table for field invited_users on 'Invite'
        db.delete_table(db.shorten_name('invites_invite_invited_users'))
    ...
    models = {
        ...
        'invites.invite': {
            ...
            'invited_users': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'}),

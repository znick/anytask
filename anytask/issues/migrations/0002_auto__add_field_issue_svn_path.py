...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Issue.svn_path'
        db.add_column('issues_issue', 'svn_path',
                      self.gf('django.db.models.fields.CharField')(max_length=254, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Issue.svn_path'
        db.delete_column('issues_issue', 'svn_path')
    ...
    models = {
        ...
        'issues.issue': {
            ...
            'svn_path': ('django.db.models.fields.CharField', [], {'max_length': '254', 'null': 'True', 'blank': 'True'}),

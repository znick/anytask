...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing M2M table for field fields on 'Issue'
        db.delete_table(db.shorten_name('issues_issue_fields'))


    def backwards(self, orm):
        # Adding M2M table for field fields on 'Issue'
        m2m_table_name = db.shorten_name('issues_issue_fields')
        ...
        db.create_unique(m2m_table_name, ['issue_id', 'issuefield_id'])
    ...
    models = {
        ...
        'courses.course': {
            ...
            'fields': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['issues.IssueField']", 'symmetrical': 'False'}),

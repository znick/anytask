...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_column('issues_event', 'type_id', 'field_id')

        # Deleting field 'Event.field_name'
        db.delete_column('issues_event', 'field_name')

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Event.type'

        # Adding field 'Event.field_name'
        db.add_column('issues_event', 'field_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Deleting field 'Event.field'
        db.rename_column('issues_event', 'field_id', 'type_id')

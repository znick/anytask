...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Issue.update_time'
        db.alter_column('issues_issue', 'update_time', self.gf('django.db.models.fields.DateTimeField')())
        # Adding field 'Event.sended_notify'
        db.add_column('issues_event', 'sended_notify',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Issue.update_time'
        db.alter_column('issues_issue', 'update_time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
        # Deleting field 'Event.sended_notify'
        db.delete_column('issues_event', 'sended_notify')

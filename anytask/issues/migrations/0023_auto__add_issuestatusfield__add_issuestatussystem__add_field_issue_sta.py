...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('issues', ['IssueStatusSystem'])

        # Adding M2M table for field statuses on 'IssueStatusSystem'
        m2m_table_name = db.shorten_name('issues_issuestatussystem_statuses')
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field statuses on 'IssueStatusSystem'
        db.delete_table(db.shorten_name('issues_issuestatussystem_statuses'))

        # Deleting field 'Issue.status_field'
        db.delete_column('issues_issue', 'status_field_id')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Issue.svn_commit_id'
        db.delete_column('issues_issue', 'svn_commit_id')

        # Deleting field 'Issue.rb_review_id'
        db.delete_column('issues_issue', 'rb_review_id')

        # Adding field 'Issue.responsible'
        db.add_column('issues_issue', 'responsible',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='responsible', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding M2M table for field followers on 'Issue'
        m2m_table_name = db.shorten_name('issues_issue_followers')
    ...
    def backwards(self, orm):
        # Adding field 'Issue.svn_commit_id'
        db.add_column('issues_issue', 'svn_commit_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Issue.rb_review_id'
        db.add_column('issues_issue', 'rb_review_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Issue.responsible'
        db.delete_column('issues_issue', 'responsible_id')

        # Removing M2M table for field followers on 'Issue'
        db.delete_table(db.shorten_name('issues_issue_followers'))

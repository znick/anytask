...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('issues_event', 'text', self.gf('django.db.models.fields.TextField')(max_length=2500))

    def backwards(self, orm):

        # Changing field 'Event.text'
        db.alter_column('issues_event', 'text', self.gf('django.db.models.fields.CharField')(max_length=250))

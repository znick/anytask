...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'IssueField'
        db.create_table('issues_issuefield', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=250)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=250, blank=True)),
            ('plugin', self.gf('django.db.models.fields.CharField')(default='DefaultPlugin', max_length=250)),
            ('plugin_version', self.gf('django.db.models.fields.CharField')(default='0.1', max_length=50)),
        ))
        db.send_create_signal('issues', ['IssueField'])


    def backwards(self, orm):
        # Deleting model 'IssueField'
        db.delete_table('issues_issuefield')

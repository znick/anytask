...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_column('issues_event', 'type', 'type_id')
        # Changing field 'Event.type'
        db.alter_column('issues_event', 'type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['issues.IssueField']))
        # Adding index on 'Event', fields ['type']
        db.create_index('issues_event', ['type_id'])


    def backwards(self, orm):
        # Removing index on 'Event', fields ['type']
        db.delete_index('issues_event', ['type_id'])


        # Renaming column for 'Event.type' to match new field type.
        db.rename_column('issues_event', 'type_id', 'type')
        # Changing field 'Event.type'
        db.alter_column('issues_event', 'type', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        'issues.event': {
            ...
            'field_name': ('django.db.models.fields.CharField', [], {'max_length': '250', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'issue': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['issues.Issue']"}),
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['issues.IssueField']"}),

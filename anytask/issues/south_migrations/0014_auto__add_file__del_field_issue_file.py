...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'File'
        db.create_table('issues_file', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
            ('deleted', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('issues', ['File'])

        # Deleting field 'Issue.file'
        db.delete_column('issues_issue', 'file')

        # Adding M2M table for field files on 'Issue'
        m2m_table_name = db.shorten_name('issues_issue_files')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('issue', models.ForeignKey(orm['issues.issue'], null=False)),
            ('file', models.ForeignKey(orm['issues.file'], null=False))
        ))
        db.create_unique(m2m_table_name, ['issue_id', 'file_id'])


    def backwards(self, orm):
        # Deleting model 'File'
        db.delete_table('issues_file')

        # Adding field 'Issue.file'
        db.add_column('issues_issue', 'file',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Removing M2M table for field files on 'Issue'
        db.delete_table(db.shorten_name('issues_issue_files'))
    ...
    models = {
        ...
        'issues.issue': {
            ...
            'files': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['issues.File']", 'symmetrical': 'False'}),

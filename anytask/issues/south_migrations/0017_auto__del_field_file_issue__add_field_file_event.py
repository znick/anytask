...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'File.event'
        db.add_column('issues_file', 'event',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['issues.Event']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column('issues_file', 'issue',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['issues.Issue']),
                      keep_default=False)

        # Deleting field 'File.event'
        db.delete_column('issues_file', 'event_id')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'IssueStatusSystem.name'
        db.alter_column('issues_issuestatussystem', 'name', self.gf('django.db.models.fields.CharField')(max_length=191))

        # Changing field 'IssueStatus.tag'
        db.alter_column('issues_issuestatus', 'tag', self.gf('django.db.models.fields.CharField')(max_length=191, null=True))

        # Changing field 'IssueStatus.name'
        db.alter_column('issues_issuestatus', 'name', self.gf('django.db.models.fields.CharField')(max_length=191))

        # Changing field 'IssueField.name'
        db.alter_column('issues_issuefield', 'name', self.gf('django.db.models.fields.CharField')(max_length=191))

        # Changing field 'IssueField.plugin'
        db.alter_column('issues_issuefield', 'plugin', self.gf('django.db.models.fields.CharField')(max_length=191))

        # Changing field 'IssueField.title'
        db.alter_column('issues_issuefield', 'title', self.gf('django.db.models.fields.CharField')(max_length=191))

        # Changing field 'IssueField.history_message'
        db.alter_column('issues_issuefield', 'history_message', self.gf('django.db.models.fields.CharField')(max_length=191))

    def backwards(self, orm):

        # Changing field 'IssueStatusSystem.name'
        db.alter_column('issues_issuestatussystem', 'name', self.gf('django.db.models.fields.CharField')(max_length=254))

        # Changing field 'IssueStatus.tag'
        db.alter_column('issues_issuestatus', 'tag', self.gf('django.db.models.fields.CharField')(max_length=254, null=True))

        # Changing field 'IssueStatus.name'
        db.alter_column('issues_issuestatus', 'name', self.gf('django.db.models.fields.CharField')(max_length=254))

        # Changing field 'IssueField.name'
        db.alter_column('issues_issuefield', 'name', self.gf('django.db.models.fields.CharField')(max_length=250))

        # Changing field 'IssueField.plugin'
        db.alter_column('issues_issuefield', 'plugin', self.gf('django.db.models.fields.CharField')(max_length=250))

        # Changing field 'IssueField.title'
        db.alter_column('issues_issuefield', 'title', self.gf('django.db.models.fields.CharField')(max_length=250))

        # Changing field 'IssueField.history_message'
        db.alter_column('issues_issuefield', 'history_message', self.gf('django.db.models.fields.CharField')(max_length=250))

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'IssueStatus.color'
        db.alter_column('issues_issuestatus', 'color', self.gf('colorfield.fields.ColorField')(max_length=18))
        # Adding unique constraint on 'Issue', fields ['student', 'task']
        db.create_unique('issues_issue', ['student_id', 'task_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Issue', fields ['student', 'task']
        db.delete_unique('issues_issue', ['student_id', 'task_id'])


        # Changing field 'IssueStatus.color'
        db.alter_column('issues_issuestatus', 'color', self.gf('colorfield.fields.ColorField')(max_length=10))

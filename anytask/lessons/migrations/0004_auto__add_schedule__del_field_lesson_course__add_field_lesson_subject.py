...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('lessons_schedule', (
            ...
            ('subject', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=100, null=True, blank=True)),
        ...
        db.delete_column('lessons_lesson', 'course_id')

        # Adding field 'Lesson.subject'
        db.add_column('lessons_lesson', 'subject',
                      self.gf('django.db.models.fields.related.ForeignKey')(db_index=False, to=orm['lessons.Schedule'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column('lessons_lesson', 'course',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['courses.Course']),
                      keep_default=False)

        # Deleting field 'Lesson.subject'
        db.delete_column('lessons_lesson', 'subject_id')

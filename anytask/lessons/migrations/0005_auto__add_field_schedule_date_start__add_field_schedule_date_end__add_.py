...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Schedule.date_start'
        db.add_column('lessons_schedule', 'date_start',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True),
                      keep_default=False)

        # Adding field 'Schedule.date_end'
        db.add_column('lessons_schedule', 'date_end',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True),
                      keep_default=False)

        # Adding field 'Schedule.days'
        db.add_column('lessons_schedule', 'days',
                      self.gf('django.db.models.fields.CharField')(db_index=True, max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Schedule.date_start'
        db.delete_column('lessons_schedule', 'date_start')

        # Deleting field 'Schedule.date_end'
        db.delete_column('lessons_schedule', 'date_end')

        # Deleting field 'Schedule.days'
        db.delete_column('lessons_schedule', 'days')
    ...
    models = {
        ...
        'lessons.lesson': {
            ...
            'subject': ('django.db.models.fields.related.ForeignKey', [], {'db_index': 'False', 'to': "orm['lessons.Schedule']", 'null': 'True', 'blank': 'True'}),

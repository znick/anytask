...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Lesson.schedule_id'
        db.add_column('lessons_lesson', 'schedule_id',
                      self.gf('django.db.models.fields.IntegerField')(db_index=True, null=True, blank=True),
                      keep_default=False)

        # Removing index on 'Lesson', fields ['title']
        db.delete_index('lessons_lesson', ['title'])


    def backwards(self, orm):
        # Adding index on 'Lesson', fields ['title']
        db.create_index('lessons_lesson', ['title'])

        # Deleting field 'Lesson.schedule_id'
        db.delete_column('lessons_lesson', 'schedule_id')

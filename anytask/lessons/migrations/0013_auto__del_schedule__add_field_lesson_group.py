...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table('lessons_schedule')

        # Adding field 'Lesson.group'
        db.add_column('lessons_lesson', 'group',
    ...
    def backwards(self, orm):
        ...
        db.create_table('lessons_schedule', (
            ('period', self.gf('django.db.models.fields.CharField')(default='Once', max_length=128)),
            ...
            ('date_end', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True)),
            ('date_start', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True)),
            ('subject', self.gf('django.db.models.fields.CharField')(blank=True, max_length=100, null=True, db_index=True)),
            ('days', self.gf('django.db.models.fields.CharField')(blank=True, max_length=100, null=True, db_index=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('lessons', ['Schedule'])

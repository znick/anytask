...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Lesson.schedule_id'
        db.alter_column('lessons_lesson', 'schedule_id', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Lesson.schedule_id'
        db.alter_column('lessons_lesson', 'schedule_id', self.gf('django.db.models.fields.IntegerField')(null=True))

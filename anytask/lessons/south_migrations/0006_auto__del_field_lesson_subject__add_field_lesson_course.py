...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('lessons_lesson', 'course',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['courses.Course']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column('lessons_lesson', 'subject',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['lessons.Schedule'], null=True, db_index=False),
                      keep_default=False)

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Lesson.period'
        db.add_column('lessons_lesson', 'period',
                      self.gf('django.db.models.fields.CharField')(default='Once', max_length=128),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Lesson.period'
        db.delete_column('lessons_lesson', 'period')

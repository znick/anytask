...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Lesson.lesson_date'
        db.delete_column('lessons_lesson', 'lesson_date')
    ...
    def backwards(self, orm):
        # Adding field 'Lesson.lesson_date'
        db.add_column('lessons_lesson', 'lesson_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True),
                      keep_default=False)
    ...
    models = {
        ...
        'lessons.lesson': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lesson_date_end': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True'}),
            'lesson_date_start': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True'}),

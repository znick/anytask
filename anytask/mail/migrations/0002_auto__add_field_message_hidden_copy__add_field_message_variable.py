...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Message.hidden_copy'
        db.add_column('mail_message', 'hidden_copy',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Message.variable'
        db.add_column('mail_message', 'variable',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding M2M table for field recipients_status on 'Message'
        m2m_table_name = db.shorten_name('mail_message_recipients_status')
        ...
        db.create_unique(m2m_table_name, ['message_id', 'userstatus_id'])


    def backwards(self, orm):
        # Deleting field 'Message.hidden_copy'
        db.delete_column('mail_message', 'hidden_copy')

        # Deleting field 'Message.variable'
        db.delete_column('mail_message', 'variable')

        # Removing M2M table for field recipients_status on 'Message'
        db.delete_table(db.shorten_name('mail_message_recipients_status'))

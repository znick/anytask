...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('mail_message', (
            ...
            ('sender', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sender+', db_index=False, to=orm['auth.User'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=191, null=True, blank=True)),
        ...
        m2m_table_name = db.shorten_name('mail_message_recipients')
        ...
        # Adding M2M table for field recipients_user on 'Message'
        m2m_table_name = db.shorten_name('mail_message_recipients_user')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('message', models.ForeignKey(orm['mail.message'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ...
        # Adding M2M table for field recipients_group on 'Message'
        m2m_table_name = db.shorten_name('mail_message_recipients_group')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('message', models.ForeignKey(orm['mail.message'], null=False)),
        ...
        # Adding M2M table for field recipients_course on 'Message'
        m2m_table_name = db.shorten_name('mail_message_recipients_course')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('message', models.ForeignKey(orm['mail.message'], null=False)),
            ('course', models.ForeignKey(orm['courses.course'], null=False))
        ))
        db.create_unique(m2m_table_name, ['message_id', 'course_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name('mail_message_recipients'))

        # Removing M2M table for field recipients_user on 'Message'
        db.delete_table(db.shorten_name('mail_message_recipients_user'))

        # Removing M2M table for field recipients_group on 'Message'
        db.delete_table(db.shorten_name('mail_message_recipients_group'))

        # Removing M2M table for field recipients_course on 'Message'
        db.delete_table(db.shorten_name('mail_message_recipients_course'))

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SchoolUserObjectPermission'
        db.create_table('schools_schooluserobjectpermission', (
            ...
            ('content_object', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['schools.School'])),
        ))
        db.send_create_signal('schools', ['SchoolUserObjectPermission'])

        # Adding unique constraint on 'SchoolUserObjectPermission', fields ['user', 'permission', 'content_object']
        db.create_unique('schools_schooluserobjectpermission', ['user_id', 'permission_id', 'content_object_id'])

        # Adding model 'SchoolGroupObjectPermission'
        db.create_table('schools_schoolgroupobjectpermission', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('permission', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.Permission'])),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.Group'])),
            ('content_object', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['schools.School'])),
        ))
        db.send_create_signal('schools', ['SchoolGroupObjectPermission'])

        # Adding unique constraint on 'SchoolGroupObjectPermission', fields ['group', 'permission', 'content_object']
        db.create_unique('schools_schoolgroupobjectpermission', ['group_id', 'permission_id', 'content_object_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'SchoolGroupObjectPermission', fields ['group', 'permission', 'content_object']
        db.delete_unique('schools_schoolgroupobjectpermission', ['group_id', 'permission_id', 'content_object_id'])

        # Removing unique constraint on 'SchoolUserObjectPermission', fields ['user', 'permission', 'content_object']
        db.delete_unique('schools_schooluserobjectpermission', ['user_id', 'permission_id', 'content_object_id'])

        # Deleting model 'SchoolUserObjectPermission'
        db.delete_table('schools_schooluserobjectpermission')

        # Deleting model 'SchoolGroupObjectPermission'
        db.delete_table('schools_schoolgroupobjectpermission')
    ...
    models = {
        ...
        'schools.schoolgroupobjectpermission': {
            'Meta': {'unique_together': "([u'group', u'permission', u'content_object'],)", 'object_name': 'SchoolGroupObjectPermission'},
            'content_object': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['schools.School']"}),
            'group': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.Group']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'permission': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.Permission']"})
        },
        'schools.schooluserobjectpermission': {
            'Meta': {'unique_together': "([u'user', u'permission', u'content_object'],)", 'object_name': 'SchoolUserObjectPermission'},
            'content_object': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['schools.School']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'permission': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.Permission']"}),

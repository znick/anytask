...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('schools_school', (
            ...
            ('link', self.gf('django.db.models.fields.CharField')(max_length=254)),
        ))
        db.send_create_signal('schools', ['School'])

        # Adding M2M table for field courses on 'School'
        m2m_table_name = db.shorten_name('schools_school_courses')
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field courses on 'School'
        db.delete_table(db.shorten_name('schools_school_courses'))
    ...
    models = {
        ...
        'schools.school': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'link': ('django.db.models.fields.CharField', [], {'max_length': '254'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '254', 'db_index': 'True'})
        },
        'years.year': {

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'School.link'
        db.alter_column('schools_school', 'link', self.gf('django.db.models.fields.CharField')(max_length=191))

        # Changing field 'School.name'
        db.alter_column('schools_school', 'name', self.gf('django.db.models.fields.CharField')(max_length=191))

    def backwards(self, orm):

        # Changing field 'School.link'
        db.alter_column('schools_school', 'link', self.gf('django.db.models.fields.CharField')(max_length=254))

        # Changing field 'School.name'
        db.alter_column('schools_school', 'name', self.gf('django.db.models.fields.CharField')(max_length=254))

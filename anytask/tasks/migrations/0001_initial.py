    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(default='All', max_length=128, choices=[('All', 's_obsuzhdeniem'), ('Only mark', 'tolko_ocenka'), ('Material', 'material'), ('Seminar', 'seminar'), ('Jupyter Notebook', 'jupyter notebook')])),
                ...
                ('group', models.ForeignKey(default=None, blank=True, to='groups.Group', null=True, db_index=False, on_delete=models.DO_NOTHING)),
                ('groups', models.ManyToManyField(related_name='groups_set', to='groups.Group')),
                ('parent_task', models.ForeignKey(related_name='children', blank=True, to='tasks.Task', null=True, on_delete=models.DO_NOTHING)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.ForeignKey(to='groups.Group', db_index=False, on_delete=models.DO_NOTHING)),
                ('task', models.ForeignKey(to='tasks.Task', db_index=False, on_delete=models.DO_NOTHING)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contest_integrated', models.BooleanField(default=False)),
                ('rb_integrated', models.BooleanField(default=False)),
                ('type', models.CharField(default='All', max_length=128, choices=[('All', 's_obsuzhdeniem'), ('Only mark', 'tolko_ocenka')])),
                ('added_time', models.DateTimeField(default=django.utils.timezone.now, auto_now_add=True)),
                ('update_time', models.DateTimeField(default=django.utils.timezone.now, auto_now=True)),
                ...
                ('group', models.ForeignKey(default=None, blank=True, to='groups.Group', null=True, db_index=False, on_delete=models.DO_NOTHING)),
                ('groups', models.ManyToManyField(related_name='groups_log_set', to='groups.Group')),
                ('parent_task', models.ForeignKey(related_name='parent_task_set', blank=True, to='tasks.TaskLog', null=True, on_delete=models.DO_NOTHING)),
                ('updated_by', models.ForeignKey(to=settings.AUTH_USER_MODEL, blank=True, null=True, db_index=False, on_delete=models.DO_NOTHING)),
            ],
            options={
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status_check', models.CharField(default='EDIT', max_length=5, db_index=True, choices=[('EDIT', '\u0414\u043e\u0440\u0435\u0448\u0438\u0432\u0430\u043d\u0438\u0435'), ('QUEUE', '\u041e\u0436\u0438\u0434\u0430\u0435\u0442 \u043f\u0440\u043e\u0432\u0435\u0440\u043a\u0438'), ('OK', '\u0417\u0430\u0434\u0430\u0447\u0430 \u0437\u0430\u0447\u0442\u0435\u043d\u0430 \u0438/\u0438\u043b\u0438 \u0431\u043e\u043b\u044c\u0448\u0435 \u043d\u0435 \u043f\u0440\u0438\u043d\u0438\u043c\u0430\u0435\u0442\u0441\u044f')])),
                ('taken_time', models.DateTimeField(null=True, blank=True)),
                ('blacklisted_till', models.DateTimeField(null=True, blank=True)),
                ('added_time', models.DateTimeField(default=django.utils.timezone.now, auto_now_add=True)),
                ('update_time', models.DateTimeField(default=django.utils.timezone.now, auto_now=True)),
                ('issue', models.ForeignKey(to='issues.Issue', null=True, on_delete=models.DO_NOTHING)),
                ('task', models.ForeignKey(to='tasks.Task', on_delete=models.DO_NOTHING)),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Task.group'
        db.alter_column('tasks_task', 'group_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['groups.Group'], null=True))


    def backwards(self, orm):
        
        # Changing field 'Task.group'
        db.alter_column('tasks_task', 'group_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['groups.Group']))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 5, 23, 44, 1, 456177)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 5, 23, 44, 1, 455923)'}),

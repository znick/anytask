...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Task.task_text'
        db.alter_column('tasks_task', 'task_text', self.gf('django.db.models.fields.TextField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Task.task_text'
        db.alter_column('tasks_task', 'task_text', self.gf('django.db.models.fields.TextField')(default=''))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 12, 2, 31, 50, 15283)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 12, 2, 31, 50, 15199)'}),

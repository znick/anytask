...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('tasks_tasktaken', 'teacher_comments', self.gf('django.db.models.fields.TextField')(default='', null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 14, 14, 17, 23, 809964)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 14, 14, 17, 23, 809882)'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('tasks_tasktakenlog', (
            ('tasktaken_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['tasks.TaskTaken'], unique=True, primary_key=True)),
        ))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 20, 19, 7, 35, 256803)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 20, 19, 7, 35, 256730)'}),
        ...
        'tasks.tasktakenlog': {
            'Meta': {'object_name': 'TaskTakenLog', '_ormbases': ['tasks.TaskTaken']},
            'tasktaken_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['tasks.TaskTaken']", 'unique': 'True', 'primary_key': 'True'})
        },
        'years.year': {

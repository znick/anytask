...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('tasks_tasktakenlog', (
            ...
            ('scored_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='task_taken_log_scored_by_set', null=True, to=orm['auth.User'])),
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 20, 19, 28, 42, 956946)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 20, 19, 28, 42, 956874)'}),

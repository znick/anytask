...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table('tasks_tasktakenlog', (
            ...
            ('scored_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='task_taken_log_scored_by_set', null=True, to=orm['auth.User'], blank=True)),
        ))
        ...
        db.create_table('tasks_tasklog', (
            ...
            ('update_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now=True, blank=True)),
            ('updated_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['auth.User'], null=True, db_index=False)),
            ('weight', self.gf('django.db.models.fields.IntegerField')(default=0, db_index=True)),
            ('parent_task', self.gf('django.db.models.fields.related.ForeignKey')(related_name='parent_task_set', null=True, to=orm['tasks.TaskLog'], blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['groups.Group'], null=True, blank=True, db_index=False)),
            ('task_text', self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True)),
            ('title', self.gf('django.db.models.fields.CharField')(blank=True, max_length=254, null=True, db_index=True)),
            ('added_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, blank=True)),
            ('score_max', self.gf('django.db.models.fields.IntegerField')(default=0, db_index=True)),
        ))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 20, 20, 32, 41, 724270)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 20, 20, 32, 41, 724198)'}),

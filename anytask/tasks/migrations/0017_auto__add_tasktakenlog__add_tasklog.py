...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'TaskTakenLog'
        db.create_table('tasks_tasktakenlog', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], db_index=False)),
            ('task', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tasks.Task'], db_index=False)),
            ('status', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=1, db_index=True)),
            ('score', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('scored_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='task_taken_log_scored_by_set', null=True, db_index=False, to=orm['auth.User'])),
            ('teacher_comments', self.gf('django.db.models.fields.TextField')(default='', null=True, blank=True)),
        ...
        db.send_create_signal('tasks', ['TaskTakenLog'])

        # Adding model 'TaskLog'
        db.create_table('tasks_tasklog', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=254, null=True, blank=True)),
            ('cource', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cources.Cource'], db_index=False)),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['groups.Group'], null=True, db_index=False, blank=True)),
            ('weight', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('parent_task', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='parent_task_set', null=True, to=orm['tasks.TaskLog'])),
            ('task_text', self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True)),
            ('score_max', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('added_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, blank=True)),
            ('update_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now=True, blank=True)),
            ('updated_by', self.gf('django.db.models.fields.related.ForeignKey')(db_index=False, to=orm['auth.User'], null=True, blank=True)),
        ))
        db.send_create_signal('tasks', ['TaskLog'])


    def backwards(self, orm):
        
        # Deleting model 'TaskTakenLog'
        db.delete_table('tasks_tasktakenlog')

        # Deleting model 'TaskLog'
        db.delete_table('tasks_tasklog')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 20, 20, 32, 46, 213564)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 20, 20, 32, 46, 213494)'}),
        ...
        'tasks.tasklog': {
            ...
            'added_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'cource': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cources.Cource']", 'db_index': 'False'}),
            'group': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['groups.Group']", 'null': 'True', 'db_index': 'False', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Task.for_all_groups'
        db.add_column('tasks_task', 'for_all_groups',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Task.for_all_groups'
        db.delete_column('tasks_task', 'for_all_groups')
    ...
    models = {
        ...
        'tasks.task': {
            ...
            'for_all_groups': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True'}),

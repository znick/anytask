...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Task.one_file_upload'
        db.add_column('tasks_task', 'one_file_upload',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Task.one_file_upload'
        db.delete_column('tasks_task', 'one_file_upload')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TaskGroupRelations.deleted'
        db.add_column('tasks_taskgrouprelations', 'deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TaskGroupRelations.deleted'
        db.delete_column('tasks_taskgrouprelations', 'deleted')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Task.accepted_after_contest_ok'
        db.add_column('tasks_task', 'accepted_after_contest_ok',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Task.accepted_after_contest_ok'
        db.delete_column('tasks_task', 'accepted_after_contest_ok')

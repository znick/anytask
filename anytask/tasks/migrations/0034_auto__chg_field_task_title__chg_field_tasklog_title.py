...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('tasks_task', 'title', self.gf('django.db.models.fields.CharField')(max_length=191, null=True))

        # Changing field 'TaskLog.title'
        db.alter_column('tasks_tasklog', 'title', self.gf('django.db.models.fields.CharField')(max_length=191, null=True))

    def backwards(self, orm):

        # Changing field 'Task.title'
        db.alter_column('tasks_task', 'title', self.gf('django.db.models.fields.CharField')(max_length=254, null=True))

        # Changing field 'TaskLog.title'
        db.alter_column('tasks_tasklog', 'title', self.gf('django.db.models.fields.CharField')(max_length=254, null=True))

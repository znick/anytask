...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TaskTaken.pdf_update_time'
        db.delete_column('tasks_tasktaken', 'pdf_update_time')

        # Deleting field 'TaskTaken.score'
        db.delete_column('tasks_tasktaken', 'score')

        # Deleting field 'TaskTaken.gr_review_update_time'
        db.delete_column('tasks_tasktaken', 'gr_review_update_time')

        # Deleting field 'TaskTaken.teacher'
        db.delete_column('tasks_tasktaken', 'teacher_id')

        # Deleting field 'TaskTaken.teacher_comments'
        db.delete_column('tasks_tasktaken', 'teacher_comments')

        # Deleting field 'TaskTaken.pdf'
        db.delete_column('tasks_tasktaken', 'pdf')

        # Deleting field 'TaskTaken.id_issue_gr_review'
        db.delete_column('tasks_tasktaken', 'id_issue_gr_review')

        # Deleting field 'TaskTaken.scored_by'
        db.delete_column('tasks_tasktaken', 'scored_by_id')

        # Adding field 'TaskTaken.issue'
        db.add_column('tasks_tasktaken', 'issue',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['issues.Issue'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'TaskTaken.pdf_update_time'
        db.add_column('tasks_tasktaken', 'pdf_update_time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'TaskTaken.score'
        db.add_column('tasks_tasktaken', 'score',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'TaskTaken.gr_review_update_time'
        db.add_column('tasks_tasktaken', 'gr_review_update_time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'TaskTaken.teacher'
        db.add_column('tasks_tasktaken', 'teacher',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='teacher', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'TaskTaken.teacher_comments'
        db.add_column('tasks_tasktaken', 'teacher_comments',
                      self.gf('django.db.models.fields.TextField')(default='', null=True, blank=True),
                      keep_default=False)

        # Adding field 'TaskTaken.pdf'
        db.add_column('tasks_tasktaken', 'pdf',
                      self.gf('django.db.models.fields.files.FileField')(default=None, max_length=100, null=True, db_index=True),
                      keep_default=False)

        # Adding field 'TaskTaken.id_issue_gr_review'
        db.add_column('tasks_tasktaken', 'id_issue_gr_review',
                      self.gf('django.db.models.fields.IntegerField')(default=None, null=True, db_index=True),
                      keep_default=False)

        # Adding field 'TaskTaken.scored_by'
        db.add_column('tasks_tasktaken', 'scored_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='task_taken_scored_by_set', null=True, to=orm['auth.User'], blank=True),
                      keep_default=False)

        # Deleting field 'TaskTaken.issue'
        db.delete_column('tasks_tasktaken', 'issue_id')

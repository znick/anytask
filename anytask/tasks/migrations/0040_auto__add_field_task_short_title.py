...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Task.short_title'
        db.add_column('tasks_task', 'short_title',
                      self.gf('django.db.models.fields.CharField')(db_index=True, max_length=15, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Task.short_title'
        db.delete_column('tasks_task', 'short_title')

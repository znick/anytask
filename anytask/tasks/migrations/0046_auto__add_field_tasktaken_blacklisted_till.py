...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TaskTaken.blacklisted_till'
        db.add_column(u'tasks_tasktaken', 'blacklisted_till',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TaskTaken.blacklisted_till'
        db.delete_column(u'tasks_tasktaken', 'blacklisted_till')
    ...
    models = {
        ...
        u'courses.course': {
            ...
            'year': ('django.db.models.fields.related.ForeignKey', [], {'default': '2019', 'to': u"orm['years.Year']"})
        },
        ...
        u'tasks.task': {
            ...
            'max_students': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
        ...
        u'tasks.tasktaken': {
            ...
            'added_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'blacklisted_till': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

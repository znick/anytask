...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('tasks_task', 'parent_task', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='parent_task_set', null=True, to=orm['tasks.Task']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Task.parent_task'
        db.delete_column('tasks_task', 'parent_task_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 6, 0, 22, 3, 352207)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 6, 0, 22, 3, 352022)'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TaskTaken.status_check'
        db.add_column('tasks_tasktaken', 'status_check',
                      self.gf('django.db.models.fields.CharField')(default='EDIT', max_length=5, db_index=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'TaskTaken.status_check'
        db.delete_column('tasks_tasktaken', 'status_check')

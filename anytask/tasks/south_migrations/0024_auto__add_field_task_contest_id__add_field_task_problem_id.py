...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Task.contest_id'
        db.add_column('tasks_task', 'contest_id',
                      self.gf('django.db.models.fields.IntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'Task.problem_id'
        db.add_column('tasks_task', 'problem_id',
                      self.gf('django.db.models.fields.CharField')(db_index=True, max_length=1, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Task.contest_id'
        db.delete_column('tasks_task', 'contest_id')

        # Deleting field 'Task.problem_id'
        db.delete_column('tasks_task', 'problem_id')
    ...
    models = {
        ...
        'tasks.task': {
            ...
            'problem_id': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '1', 'null': 'True', 'blank': 'True'}),

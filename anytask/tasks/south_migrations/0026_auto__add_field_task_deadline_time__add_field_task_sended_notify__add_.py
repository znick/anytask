...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Task.deadline_time'
        db.add_column('tasks_task', 'deadline_time',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True),
                      keep_default=False)

        # Adding field 'Task.sended_notify'
        db.add_column('tasks_task', 'sended_notify',
                      self.gf('django.db.models.fields.BooleanField')(default=True, db_index=True),
                      keep_default=False)

        # Adding field 'TaskLog.deadline_time'
        db.add_column('tasks_tasklog', 'deadline_time',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True),
                      keep_default=False)

        # Adding field 'TaskLog.contest_id'
        db.add_column('tasks_tasklog', 'contest_id',
                      self.gf('django.db.models.fields.IntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'TaskLog.problem_id'
        db.add_column('tasks_tasklog', 'problem_id',
                      self.gf('django.db.models.fields.CharField')(db_index=True, max_length=128, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Task.deadline_time'
        db.delete_column('tasks_task', 'deadline_time')

        # Deleting field 'Task.sended_notify'
        db.delete_column('tasks_task', 'sended_notify')

        # Deleting field 'TaskLog.deadline_time'
        db.delete_column('tasks_tasklog', 'deadline_time')

        # Deleting field 'TaskLog.contest_id'
        db.delete_column('tasks_tasklog', 'contest_id')

        # Deleting field 'TaskLog.problem_id'
        db.delete_column('tasks_tasklog', 'problem_id')

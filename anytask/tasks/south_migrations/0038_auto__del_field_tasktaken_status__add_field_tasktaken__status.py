...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TaskTaken._status'
        db.add_column('tasks_tasktaken', '_status',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=1, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'TaskTaken.status'
        db.add_column('tasks_tasktaken', 'status',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=1, db_index=True),
                      keep_default=False)

        # Deleting field 'TaskTaken._status'
        db.delete_column('tasks_tasktaken', '_status')
    ...
    models = {
        ...
        'tasks.tasktaken': {
            ...
            '_status': ('django.db.models.fields.IntegerField', [], {'default': '0', 'max_length': '1', 'db_index': 'True'}),
            'added_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

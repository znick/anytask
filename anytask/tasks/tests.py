...
class ViewsTest(TestCase):
    ...
    @skipIf(IS_MYSQL_DATABASE, "Fails after switching to MySQL: navbar link wrong")
    ...
    @skipIf(IS_MYSQL_DATABASE, "Fails after switching to MySQL: Can't get get_contest_info via teacher")

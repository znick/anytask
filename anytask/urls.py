...
urlpatterns = patterns('',
    ...
    url(r'^shad2017/ya_form_register', 'admission.views.register'),
    ...
    url(r'^shad2017/results/(?P<username>.*)/', 'admission.views.contest_results_redirect'),
    url(r'^shad2017/contest_register/(?P<username>.*)/', 'admission.views.contest_register_and_redirect'),
)

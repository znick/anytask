...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'UserProfileLog', fields ['user']
        db.delete_unique('users_userprofilelog', ['user_id'])


    def backwards(self, orm):
        # Adding unique constraint on 'UserProfileLog', fields ['user']
        db.create_unique('users_userprofilelog', ['user_id'])

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        m2m_table_name = db.shorten_name('users_userprofile_unread_messages')
        ...
        # Adding M2M table for field deleted_messages on 'UserProfile'
        m2m_table_name = db.shorten_name('users_userprofile_deleted_messages')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm['users.userprofile'], null=False)),
            ('message', models.ForeignKey(orm['mail.message'], null=False))
        ...
        # Adding M2M table for field send_notify_messages on 'UserProfile'
        m2m_table_name = db.shorten_name('users_userprofile_send_notify_messages')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm['users.userprofile'], null=False)),
            ('message', models.ForeignKey(orm['mail.message'], null=False))
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name('users_userprofile_unread_messages'))

        # Removing M2M table for field deleted_messages on 'UserProfile'
        db.delete_table(db.shorten_name('users_userprofile_deleted_messages'))

        # Removing M2M table for field send_notify_messages on 'UserProfile'
        db.delete_table(db.shorten_name('users_userprofile_send_notify_messages'))

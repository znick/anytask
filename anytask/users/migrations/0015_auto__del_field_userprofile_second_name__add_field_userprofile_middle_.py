...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserProfile.second_name'
        db.delete_column('users_userprofile', 'second_name')

        # Adding field 'UserProfile.middle_name'
        db.add_column('users_userprofile', 'middle_name',
        ...
        # Adding field 'UserProfile.city_of_residence'
        db.add_column('users_userprofile', 'city_of_residence',
        ...
        # Adding field 'UserProfile.university_in_process'
        db.add_column('users_userprofile', 'university_in_process',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'UserProfile.university_class'
        db.add_column('users_userprofile', 'university_class',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.university_department'
        db.add_column('users_userprofile', 'university_department',
                      self.gf('django.db.models.fields.CharField')(max_length=191, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.university_year_end'
        db.add_column('users_userprofile', 'university_year_end',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.additional_info'
        db.add_column('users_userprofile', 'additional_info',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.login_via_yandex'
        db.add_column('users_userprofile', 'login_via_yandex',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'UserProfile.second_name'
        db.add_column('users_userprofile', 'second_name',
        ...
        db.delete_column('users_userprofile', 'middle_name')

        # Deleting field 'UserProfile.phone'
        db.delete_column('users_userprofile', 'phone')

        # Deleting field 'UserProfile.city_of_residence'
        db.delete_column('users_userprofile', 'city_of_residence')

        # Deleting field 'UserProfile.university'
        db.delete_column('users_userprofile', 'university')

        # Deleting field 'UserProfile.university_in_process'
        db.delete_column('users_userprofile', 'university_in_process')

        # Deleting field 'UserProfile.university_class'
        db.delete_column('users_userprofile', 'university_class')

        # Deleting field 'UserProfile.university_department'
        db.delete_column('users_userprofile', 'university_department')

        # Deleting field 'UserProfile.university_year_end'
        db.delete_column('users_userprofile', 'university_year_end')

        # Deleting field 'UserProfile.additional_info'
        db.delete_column('users_userprofile', 'additional_info')

        # Deleting field 'UserProfile.login_via_yandex'
        db.delete_column('users_userprofile', 'login_via_yandex')

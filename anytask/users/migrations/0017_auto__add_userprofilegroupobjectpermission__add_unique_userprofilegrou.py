...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserProfileGroupObjectPermission'
        db.create_table('users_userprofilegroupobjectpermission', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('permission', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.Permission'])),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.Group'])),
            ('content_object', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.UserProfile'])),
        ))
        db.send_create_signal('users', ['UserProfileGroupObjectPermission'])

        # Adding unique constraint on 'UserProfileGroupObjectPermission', fields ['group', 'permission', 'content_object']
        db.create_unique('users_userprofilegroupobjectpermission', ['group_id', 'permission_id', 'content_object_id'])

        # Adding model 'UserProfileUserObjectPermission'
        db.create_table('users_userprofileuserobjectpermission', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('users', ['UserProfileUserObjectPermission'])

        # Adding unique constraint on 'UserProfileUserObjectPermission', fields ['user', 'permission', 'content_object']
        db.create_unique('users_userprofileuserobjectpermission', ['user_id', 'permission_id', 'content_object_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'UserProfileUserObjectPermission', fields ['user', 'permission', 'content_object']
        db.delete_unique('users_userprofileuserobjectpermission', ['user_id', 'permission_id', 'content_object_id'])

        # Removing unique constraint on 'UserProfileGroupObjectPermission', fields ['group', 'permission', 'content_object']
        db.delete_unique('users_userprofilegroupobjectpermission', ['group_id', 'permission_id', 'content_object_id'])

        # Deleting model 'UserProfileGroupObjectPermission'
        db.delete_table('users_userprofilegroupobjectpermission')

        # Deleting model 'UserProfileUserObjectPermission'
        db.delete_table('users_userprofileuserobjectpermission')
    ...
    models = {
        ...
        'users.userprofilegroupobjectpermission': {
            'Meta': {'unique_together': "([u'group', u'permission', u'content_object'],)", 'object_name': 'UserProfileGroupObjectPermission'},
            'content_object': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['users.UserProfile']"}),
        ...
        'users.userprofileuserobjectpermission': {
            'Meta': {'unique_together': "([u'user', u'permission', u'content_object'],)", 'object_name': 'UserProfileUserObjectPermission'},
            'content_object': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['users.UserProfile']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'permission': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.Permission']"}),

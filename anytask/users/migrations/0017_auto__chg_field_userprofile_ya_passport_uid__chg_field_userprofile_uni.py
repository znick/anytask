...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.ya_contest_uid'
        db.alter_column('users_userprofile', 'ya_contest_uid', self.gf('django.db.models.fields.CharField')(max_length=191, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'UserProfile.ya_contest_uid'
        db.alter_column('users_userprofile', 'ya_contest_uid', self.gf('django.db.models.fields.IntegerField')(null=True))

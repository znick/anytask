...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfileLog.ya_passport_uid'
        db.alter_column('users_userprofilelog', 'ya_passport_uid', self.gf('django.db.models.fields.CharField')(max_length=191, null=True))

        # Changing field 'UserProfileLog.university_class'
        db.alter_column('users_userprofilelog', 'university_class', self.gf('django.db.models.fields.CharField')(max_length=191, null=True))

        # Changing field 'UserProfileLog.ya_contest_uid'
        db.alter_column('users_userprofilelog', 'ya_contest_uid', self.gf('django.db.models.fields.CharField')(max_length=191, null=True))

        # Changing field 'UserProfileLog.university_year_end'
        db.alter_column('users_userprofilelog', 'university_year_end', self.gf('django.db.models.fields.CharField')(max_length=191, null=True))

    def backwards(self, orm):

        # Changing field 'UserProfileLog.ya_passport_uid'
        db.alter_column('users_userprofilelog', 'ya_passport_uid', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'UserProfileLog.university_class'
        db.alter_column('users_userprofilelog', 'university_class', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'UserProfileLog.ya_contest_uid'
        db.alter_column('users_userprofilelog', 'ya_contest_uid', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'UserProfileLog.university_year_end'
        db.alter_column('users_userprofilelog', 'university_year_end', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))
    ...
    models = {
        ...
        'users.userprofile': {
            ...
            'login_via_yandex': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'university_class': ('django.db.models.fields.CharField', [], {'max_length': '191', 'null': 'True', 'blank': 'True'}),
            ...
            'university_year_end': ('django.db.models.fields.CharField', [], {'max_length': '191', 'null': 'True', 'blank': 'True'}),
            ...
            'ya_contest_uid': ('django.db.models.fields.CharField', [], {'max_length': '191', 'null': 'True', 'blank': 'True'}),
            ...
            'ya_passport_uid': ('django.db.models.fields.CharField', [], {'max_length': '191', 'null': 'True', 'blank': 'True'}),

...
class UserProfileIndex(indexes.SearchIndex, indexes.Indexable):
    ...
    ya_contest_login_auto = indexes.NgramField(model_attr='ya_contest_login', default='')
    ya_passport_email_auto = indexes.NgramField(model_attr='ya_passport_email', default='')

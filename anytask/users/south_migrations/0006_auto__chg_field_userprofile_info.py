...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('users_userprofile', 'info', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'UserProfile.info'
        db.alter_column('users_userprofile', 'info', self.gf('django.db.models.fields.TextField')())

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.ya_contest_uid'
        db.add_column('users_userprofile', 'ya_contest_uid',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.ya_contest_login'
        db.add_column('users_userprofile', 'ya_contest_login',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.ya_passport_uid'
        db.add_column('users_userprofile', 'ya_passport_uid',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.ya_passport_login'
        db.add_column('users_userprofile', 'ya_passport_login',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.ya_passport_email'
        db.add_column('users_userprofile', 'ya_passport_email',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.ya_contest_uid'
        db.delete_column('users_userprofile', 'ya_contest_uid')

        # Deleting field 'UserProfile.ya_contest_login'
        db.delete_column('users_userprofile', 'ya_contest_login')

        # Deleting field 'UserProfile.ya_passport_uid'
        db.delete_column('users_userprofile', 'ya_passport_uid')

        # Deleting field 'UserProfile.ya_passport_login'
        db.delete_column('users_userprofile', 'ya_passport_login')

        # Deleting field 'UserProfile.ya_passport_email'
        db.delete_column('users_userprofile', 'ya_passport_email')
